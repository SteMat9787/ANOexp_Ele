...
load('Controls_allWords_Max_corr_DSMs_CARD-SORTING10000iter_40sub.mat')
...
disp (strcat('WithinGrCorr-CONneutre:',num2str(mean(r_SCneutre))));
disp (strcat('WithinGrCorr-CONolfa:',num2str(mean(r_SColfa))));
