...
load('Anosmics_allWords_Max_corr_DSMs_CARD-SORTING10000iter_40sub.mat')
...
disp (strcat('WithinGrCorr-ANOneutre:',num2str(mean(r_ACneutre))));
disp (strcat('WithinGrCorr-ANOolfa:',num2str(mean(r_AColfa))));
