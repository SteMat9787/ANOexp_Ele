...
meanANOneutre=mean(all_CON_Neutre);
meanANOolfa=mean(all_CON_Olfa);
...
save(strcat(output_path,'Controls_allWords_ITER_BetweenTasks_corrDSMs',Task_name,'_allSub'),'Mean_betweenGr_corr','ITER_Mean_betweenGr_corr');
